...
#    offset_salt_y = 0.01132
#    offset_salt_x = 0.02137
    offset_salt_y = 1.618
    offset_salt_x = 3.14159
    ...
    def quasi(self, zfill, midon, symmetry, maxmax, plotter):
        ...
        # Initialize vectors
        # (avoid a dive by zero exception for even symmetries)
    ...
    #                                x0 /= mrt
                                ...
                                if not flag:
                                    ...
                                    if midon[0] > 0 or midon[1] > 0:
                                        ...
                                        if dist1 * dist2 < 0.1:
                                            segtype = midon[0] # Skinny
                                        else:
                                            segtype = midon[1] # Fat
                                        if dist1 > dist2:
                                            if segtype == Quasi.SEG_MIDP_ACUTE:
                                                segtype = Quasi.SEG_MIDP_OBTUSE
                                            elif segtype == Quasi.SEG_MIDP_OBTUSE:
                                                segtype = Quasi.SEG_MIDP_ACUTE
                                            elif segtype == Quasi.SEG_VERT_ACUTE:
                                                segtype = Quasi.SEG_VERT_OBTUSE
                                            elif segtype == Quasi.SEG_VERT_OBTUSE:
                                                segtype = Quasi.SEG_VERT_ACUTE
